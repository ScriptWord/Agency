...
We removed the ‘next-export’ support from our template from version 11.0.0 and we recommend to use ‘next-build’ and ‘next-start’ to run our template. It is also recommended by Next Js
